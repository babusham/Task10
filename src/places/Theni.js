    ...
    <div id="theni">
      ...
      <div className="container">
        <div className="row row-cols-auto">
          <div className="col">
          <Card style={{ width: '15rem', height: '22rem', fontSize: '0.9rem' }}>
              <Card.Img
                variant="top"
                src={require('../images/theni1.jpeg')}
              />
              <Card.Body>
                <Card.Title style={{fontSize:'1.1rem'}}>Chinna Suruli Falls</Card.Title>
                <Card.Text>
          ...
          <Card style={{ width: '15rem', height: '22rem', fontSize: '0.9rem' }}>
              <Card.Img
                variant="top"
                src={require('../images/theni2.jpeg')}
              />
              <Card.Body>
                <Card.Title style={{fontSize:'1.1rem'}}>Kumbakkarai Falls </Card.Title>
                <Card.Text>
          ...
          <Card style={{ width: '15rem', height: '22rem', fontSize: '0.9rem' }}>
              <Card.Img
                variant="top"
                src={require('../images/theni3.jpeg')}
              />
              <Card.Body>
          ...
          <div class="col">
            <Card style={{ width: '15rem', height: '22rem', fontSize: '0.9rem' }}>
              <Card.Img
                variant="top"
                src={require('../images/theni4.jpeg')}
              />
              <Card.Body>
                <Card.Title style={{fontSize:'1.1rem'}}>Suruli Falls</Card.Title>
                <Card.Text>
