...
import '../TimeToVisit/Chennai.css'
import { Row,Col } from 'react-bootstrap'
import {Button,Offcanvas } from 'react-bootstrap';
import Modal from 'react-bootstrap/Modal';
import Chennai1 from '../../pics/Chennai1.jpeg'
import Chennai2 from '../../pics/Chennai2.jpeg'
import Chennai3 from '../../pics/Chennai3.jpeg'
    ...
    <div className='container'>
      ...
      <Row className="align-items-center">
        <Col md={6}  className="text-right">
          ...
          <p className='besttimetovisit-text fs-6'> 
          ...
          <p className='besttimetovisit-text besttimetovisit-bottomtext fs-6'>
         ...
         <div
            ...
            <Modal.Dialog>
              <Modal.Header closeButton>
                <Modal.Title className='text-center modal-heading fs-5' >More About Best Time To Travel To Chennai</Modal.Title>
              </Modal.Header>
