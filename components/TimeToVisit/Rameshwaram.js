...
import Rameswaram1 from '../../pics/Rameshwaram1.jpeg';
import Rameswaram2 from '../../pics/Rameshwaram2.jpeg';
import Rameswaram3 from '../../pics/Rameshwaram3.jpeg';
...
const Rameswaram = () => {
  ...
  return (
    <div className='container even-marginbttom'>
      <h3 className='besttimetovisit-primary-heading'>02. Rameshwaram</h3>
      <Row className="align-items-center">
          ...
          <div
            ...
            <Modal.Dialog show={isModalOpen} onHide={handleClose} backdrop={false}>
              <Modal.Header closeButton>
                <Modal.Title className='text-center modal-heading fs-5'>More About Best Time To Travel To Rameshwaram</Modal.Title>
              </Modal.Header>
                  ...
                  <div className='row'>
                    ...
                    <div className='col-sm-4'>
                      <img 
                        ...
                        style={{width:'100px',height:'150px'}}
                      />
                      <p className='text-center'>Lighthouse Source</p>
                    </div>
                    <div className='col-sm-4'>
                      <img 
                       src={Rameswaram3} 
                       ...
                       style={{width:'100px',height:'150px'}}
                     />  
                     <p className='text-center'>Pilgrims Temple Source</p>
                    </div>
                  </div>
                </div>
       ...
       <Col md={6}  className="text-right">
             <h4 className='besttimetovisit-primary-sub-heading fs-5'>What is the best time to visit:</h4>
